class FollowersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @follower.save
        ...
        format.html { redirect_to my_followers_path, notice: 'Follower was successfully created.' }
  ...
  def destroy
    @follower.destroy
    respond_to do |format|
      format.html { redirect_to my_followers_path, notice: 'Follower was successfully destroyed.' }
